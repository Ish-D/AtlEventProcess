/**
 * @file eformat/python/container.h
 * @author <a href="mailto:andre.dos.anjos@cern.ch">Andre Anjos</a> 
 *
 * @brief Allows rvalue implicit conversion for methods that take std::vectors
 * and such. 
 *
 * Code extracted from: http://cctbx.svn.sourceforge.net/viewvc/cctbx/trunk/scitbx/boost_python/container_conversions.h
 */

#ifndef EFORMAT_PYTHON_CONTAINER_H 
#define EFORMAT_PYTHON_CONTAINER_H
  ...
  struct from_python_sequence
  {
    ...
    static void* convertible(PyObject* obj_ptr)
    {
      ...
      if (ConversionPolicy::check_convertibility_per_element()) {
        ...
        unsigned int obj_size_unsigned = obj_size;
        if (!is_range) assert(i == obj_size_unsigned);
      }
      return obj_ptr;
    }
...
#endif /* EFORMAT_PYTHON_CONTAINER_H */
